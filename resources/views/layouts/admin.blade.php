...
<body class="app sidebar-mini">
        ...
        <ul class="app-nav">
            ...
            <li class="dropdown"><a class="app-nav__item" href="#" data-bs-toggle="dropdown"
                ...
                <ul class="dropdown-menu settings-menu dropdown-menu-right">
                    <li><a class="dropdown-item" href="{{ route('admin_profil', Auth::user()->id) }}"><i
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <li>
                <a class="app-menu__item {{ Route::is('lomba') ? 'active' : '' }}" href="/lomba">
                    <i class="app-menu__icon bi bi-award"></i><span class="app-menu__label">Manajemen Lomba</span>
                </a>
            </li>
            <li>
                <a class="app-menu__item {{ Route::is('prestasi') ? 'active' : '' }}" href="/prestasi">
